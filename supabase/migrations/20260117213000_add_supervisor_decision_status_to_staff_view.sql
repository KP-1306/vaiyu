-- ============================================================
-- Migration: Add supervisor_decision_status to v_staff_runner_tickets
-- Purpose: Staff UI needs to know if supervisor made a decision
--          so it can show "REJECTED" instead of "WAITING FOR SUPERVISOR"
-- ============================================================
...
SELECT
    ...
    -- =========================================================================
    -- NEW: Supervisor decision status for BLOCKED + supervisor_approval tickets
    -- =========================================================================
    -- Returns:
    --   'PENDING'  - Waiting for supervisor decision
    --   'APPROVED' - Supervisor approved (note: ticket should be unblocked after this)
    --   'REJECTED' - Supervisor rejected, staff must take action
    --   NULL       - Not a supervisor approval block
    -- =========================================================================
    CASE
