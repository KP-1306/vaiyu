  ...
  return (
    <div className="rounded-2xl border border-slate-800 bg-[#0F1320] p-8 sm:p-10 text-center">
      ...
      <p className="mt-1 text-sm text-slate-400 max-w-md mx-auto">
        Follow-ups appear here automatically when you add a lead in your CRM, or when you
        send a quote. You can also add one manually.
      </p>
      <p className="mt-1 text-xs text-slate-500 italic max-w-md mx-auto">
        Jab aap Leads mein nayi enquiry add karte hain, follow-up yahan apne aap aa jaata hai.
      </p>
