      ...
      <main className="max-w-3xl mx-auto p-6 bg-slate-50">
        ...
        <div className="mt-4 rounded-2xl border bg-white p-6 shadow-sm">
          ...
          <p className="text-sm text-slate-600">
            We couldn’t find this property. Open it from the Owner Home screen
            and try again.
          </p>
          <div className="mt-4">
        ...
        <header className="flex flex-col gap-3 rounded-3xl border border-slate-100 bg-white/90 px-4 py-4 shadow-sm shadow-slate-200/60 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-slate-600">
              Create open roles for this property, see applicants in one place,
              and move them to shortlisted or hired in a single tap.
            </p>
            {!workforceEnabled && (
              <p className="mt-1 text-[11px] text-amber-700">
                Workforce is not fully enabled yet in this project. The UI is
                safe to explore; saving requires the{" "}
...
function FilterBar(props: {
  ...
  return (
    <div className="rounded-2xl border border-slate-100 bg-white/80 px-3 py-3 shadow-sm flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
