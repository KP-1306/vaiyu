...
export default function Contact() {
  ...
  function sendViaEmail(e?: React.MouseEvent) {
    ...
    setOk(t("mailtoOk", "Opening your email client… If nothing appears, write to support@vaiyu.co.in."));
  }
  ...
  return (
    <main id="main" className="min-h-screen bg-[#0a0a0c] text-[#f5f3ef]">
      <SEO
        ...
        description={t("seo.desc", "Request a demo or ask anything about VAiyu — AI OS for hotels.")}
      />
      ...
      >
        <div className="relative z-[1] mx-auto max-w-6xl px-4 py-16 sm:py-20">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight sm:text-5xl">{t("hero.title", "Contact VAiyu")}</h1>
          <p
            className="mt-3 max-w-2xl text-[#b8b3a8] [&_b]:text-[#f5f3ef]"
            dangerouslySetInnerHTML={{
              __html: t("hero.subtitleHtml", "Partner with us to bring <b>truth-anchored AI</b> to your hotel — faster service, clearer SLAs, happier guests."),
            }}
          />
      ...
      <section id="form" className="mx-auto max-w-6xl px-4 py-10 grid gap-8 lg:grid-cols-3">
        ...
        <div className="space-y-4">
          <div className="bg-[#141210]/90 backdrop-blur-md border border-[#d4af37]/20 rounded-2xl p-6 shadow-[0_4px_24px_rgba(0,0,0,0.4)]">
            <h2 className="text-lg font-semibold text-[#f5f3ef]">{t("sales.title", "Talk to sales")}</h2>
            <p className="mt-1 text-sm text-[#b8b3a8]">{t("sales.desc", "Rollout, pricing, ROI.")}</p>
          ...
          <div className="bg-[#141210]/90 backdrop-blur-md border border-[#d4af37]/20 rounded-2xl p-6 shadow-[0_4px_24px_rgba(0,0,0,0.4)]">
            <h2 className="text-lg font-semibold text-[#f5f3ef]">{t("support.title", "Customer support")}</h2>
            <p className="mt-1 text-sm text-[#b8b3a8]">{t("support.desc", "We’re here 24×7 for critical issues.")}</p>
          ...
          <div className="bg-[#141210]/90 backdrop-blur-md border border-[#d4af37]/20 rounded-2xl p-6 shadow-[0_4px_24px_rgba(0,0,0,0.4)]">
            <h2 className="text-lg font-semibold text-[#f5f3ef]">{t("press.title", "Press & partnerships")}</h2>
            <p className="mt-1 text-sm text-[#b8b3a8]">{t("press.desc", "Media kit, interviews, ecosystem.")}</p>
            <a className="inline-flex items-center justify-center px-4 py-2 mt-4 font-medium bg-[#1a1816] text-[#b8b3a8] border border-[#d4af37]/20 rounded-xl hover:bg-[#24221f] hover:text-[#f5f3ef] transition-colors w-full sm:w-auto" href="/press">
              {t("press.link", "Press resources")}
            </a>
          </div>

          <div className="bg-[#141210]/90 backdrop-blur-md border border-[#d4af37]/20 rounded-2xl p-6 shadow-[0_4px_24px_rgba(0,0,0,0.4)]">
            <h2 className="text-lg font-semibold text-[#f5f3ef]">{t("offices.title", "Offices")}</h2>
            <div className="mt-3 text-sm text-[#b8b3a8] space-y-3">
              <div>
                <div className="font-medium text-[#e9c55a]">{t("offices.globalLabel", "Global (Remote-first)")}</div>
                <div className="text-[#7a756a] mt-0.5">{t("offices.globalDesc", "Teams across IST • CET • PT")}</div>
              </div>
              <div className="h-px bg-[#d4af37]/10 w-full" />
              <div>
                <div className="font-medium text-[#e9c55a]">{t("offices.hqLabel", "Registered HQ")}</div>
                <div className="text-[#7a756a] mt-0.5">{t("offices.hqDesc", "Will update on launch")}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2">
          <div className="bg-[#141210]/90 backdrop-blur-md border border-[#d4af37]/20 rounded-2xl p-6 sm:p-8 shadow-[0_4px_24px_rgba(0,0,0,0.4)] space-y-4">
            <h2 className="text-xl font-semibold text-[#f5f3ef]">{t("form.title", "Send us a message")}</h2>
              ...
              onSubmit={async (e) => {
                ...
                try {
                  ...
                  if (res.ok) {
                    ...
                    setError(t("errors.generic", "Something went wrong. Please try the ‘Send via email’ button instead."));
                    setSending(false);
                  }
                } catch {
                  setError(t("errors.network", "Network error. Please try the ‘Send via email’ button instead."));
                  setSending(false);
                }
              }}
              className="space-y-4"
            >
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <label className="text-sm font-medium text-[#b8b3a8] sm:col-span-2">
                  ...
                  <input
                    className="w-full mt-1.5 bg-[#1a1816]/80 border border-[#d4af37]/20 rounded-xl px-4 py-3 text-[#f5f3ef] placeholder:text-[#7a756a] focus:outline-none focus:border-[#d4af37]/60 focus:ring-1 focus:ring-[#d4af37]/60 transition-all"
                    placeholder={t("form.subjectPlaceholder", "Optional")}
                ...
                <label className="text-sm font-medium text-[#b8b3a8] sm:col-span-2">
                  ...
                  <textarea
                    ...
                    placeholder={t("form.messagePlaceholder", "Tell us a bit about your property and goals…")}
                    required
                  />
                </label>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                <button
                  ...
                  type="submit"
                >
                  {sending ? t("form.sending", "Sending…") : t("form.submit", "Request a demo")}
                </button>
                ...
                >
                  {t("form.sendEmail", "Send via email")}
                </button>
              </div>

              <div
                className="text-xs text-[#7a756a] mt-4 [&_a]:text-[#d4af37] [&_a:hover]:text-[#e9c55a] [&_a]:underline [&_a]:decoration-[#d4af37]/30 [&_a]:underline-offset-4 [&_a]:transition-colors"
                dangerouslySetInnerHTML={{
                  __html: t("form.consentHtml", "By contacting us you agree to our <a href=\"/privacy\">Privacy Policy</a>."),
                }}
              />
            </form>
            ...
            <div className="pt-2">
              <p
                className="text-sm text-[#7a756a] [&_a]:text-[#d4af37] [&_a:hover]:text-[#e9c55a] [&_a]:underline [&_a]:decoration-[#d4af37]/30 [&_a]:underline-offset-4 [&_a]:transition-colors"
                dangerouslySetInnerHTML={{
                  __html: t("form.preferHtml", "Prefer to write directly? Email <a href=\"mailto:support@vaiyu.co.in\">support@vaiyu.co.in</a>."),
                }}
              />
            </div>
          </div>
          ...
          <div className="mt-6 bg-[#141210]/90 backdrop-blur-md border border-[#d4af37]/20 rounded-2xl p-6 shadow-[0_4px_24px_rgba(0,0,0,0.4)]">
            <h3 className="text-base font-semibold text-[#f5f3ef]">{t("faq.title", "FAQ")}</h3>
            <ul className="mt-3 text-sm text-[#b8b3a8] list-disc pl-5 space-y-2 [&_a]:text-[#d4af37] [&_a:hover]:text-[#e9c55a] [&_a]:underline [&_a]:decoration-[#d4af37]/30 [&_a]:underline-offset-4 [&_a]:transition-colors">
              <li>{t("faq.item1", "We typically respond within one business day.")}</li>
              <li dangerouslySetInnerHTML={{ __html: t("faq.item2Html", "For urgent issues, please write to <a href=\"mailto:support@vaiyu.co.in\">support@vaiyu.co.in</a>.") }} />
              <li>{t("faq.item3", "We support pilots for single properties as well as chains.")}</li>
            </ul>
          </div>
        </div>
      </section>
