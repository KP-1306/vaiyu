-- Analytics RPCs for Owner Dashboard (Production Grade)
-- Replaces simple views to handle Timezones and Zero-filling
...
BEGIN
  ...
  daily_data AS (
    ...
    WHERE
      ...
      -- Compare TIMESTAMPTZ with TIMESTAMPTZ to avoid session timezone ambiguity
