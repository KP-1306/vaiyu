      ...
      <div className="flex items-start gap-2">
        ...
        <div className="space-y-1">
          <p className="font-semibold uppercase tracking-wide text-[10px] text-slate-400">
            Internal planning tool — publishes nothing
          </p>
          <p className="leading-relaxed">{LOCAL_SEO_DISCLAIMER}</p>
          <p className="leading-relaxed text-slate-400">{LOCAL_SEO_DISCLAIMER_HI}</p>
        </div>
      </div>
    </aside>
  );
