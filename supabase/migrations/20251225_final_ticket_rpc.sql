-- ============================================================
-- FINAL PRODUCTION RPC: create_service_request
-- Vaiyu | Hospitality Service Request Engine
-- ============================================================
-- Guarantees:
-- • Atomic ticket creation
-- • Clean SLA lifecycle (policy + trigger driven)
-- • Correct audit trail
-- • Shift-aware, workload-aware auto-assignment
-- • Zero UI business logic
--
-- NOTE:
-- This function runs in a single implicit transaction.
-- ============================================================
...
BEGIN
  ...
  WHERE
    ...
    AND hm.department_id = p_department_id
    AND hm.role = 'STAFF'
