...
CREATE VIEW v_staff_runner_tickets AS
SELECT
  -- ==========================================================
  -- Core Identity
  -- ==========================================================
  ...
  -- ==========================================================
  -- SLA STATE (⭐ THIS IS THE KEY ⭐)
  -- ==========================================================
  CASE
    WHEN ss.sla_started_at IS NULL
      THEN 'NOT_STARTED'

    WHEN ss.breached = true
      THEN 'BREACHED'
  ...
  CASE
    ...
    WHEN ss.current_remaining_seconds > 0
      THEN CONCAT(
        CEIL(ss.current_remaining_seconds / 60.0),
        ' min remaining'
      )
