...
export default function BackHome({
  ...
  const hide = startsWithAny(pathname, HIDE_PREFIXES) || pathname.endsWith("/staff-shifts") || pathname === "/owner/services" || pathname.endsWith("/analytics") || (pathname.startsWith("/stay/") && pathname.endsWith("/requests")) || pathname.startsWith("/menu") || pathname.endsWith("/menu");
