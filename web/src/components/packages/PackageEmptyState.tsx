  ...
  return (
    <div className="rounded-2xl border border-slate-800 bg-[#0F1320] p-8 sm:p-10 text-center">
      ...
      <p className="mt-1 text-sm text-slate-400 max-w-md mx-auto">
        Build experience packages your team can share with guests — weekend escapes,
        Char Dham yatra, family stays, wellness retreats. Drafts stay private until
        you publish.
      </p>
      <p className="mt-1 text-xs text-slate-500 italic max-w-md mx-auto">
        Apne hotel ke special packages yahan banayein. Guest ko share karne ke liye public link mil jaayega.
      </p>
